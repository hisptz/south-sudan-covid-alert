export const PREDEFINED_MENU_ITEMS = [
  ...
  },
  {
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'A set of groups of data elements used for analysis and cross tabulation',
    onlyShowOnSearch: true,
  },
  {
    name: 'Indicator',
  ...
  },
  {
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Type of indicator used as a factor, such as percentages, rates and ratios',
    onlyShowOnSearch: true,
  },
  {
  ...
  },
  {
    ...
    description:
      'User settings for updating language, theme and notification settings',
    onlyShowOnSearch: true,
  },
  {
    name: 'Profile',
    ...
    description:
      'User settings for updating names, email, phone number and other profile details',
    onlyShowOnSearch: true,
  },
  {
    name: 'Account',
  ...
  },
  {
    ...
    description:
      'Details about running dhis2 versions, database and other setup information',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/categorySection/categoryOption',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Disagregation of data elements and data set for cross tabulation on data entry and analysis',
    onlyShowOnSearch: true,
  },
  {
    name: 'Category',
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Combination of options used as disaggregation of data elements and datasets for cross tabulation',
    onlyShowOnSearch: true,
  },
  {
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Set of combinations of options used as disaggregation of data elements and datasets for cross tabulation',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/categorySection/categoryOptionCombo',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Generated individual disaggregation/cross-tabulations based on category combination',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      ' /dhis-web-maintenance/#/list/categorySection/categoryOptionGroup',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Group of options used for cross tabulation during data analysis',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/categorySection/categoryOptionGroupSet',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'A set of groups of options used for cross tabulation during data analysis',
    onlyShowOnSearch: true,
  },
  {
    name: 'Data set',
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'A set of data elements used for data collection and reporting rates/data submission',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/indicatorSection/indicatorGroupSet',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'A set of groups of indicators used for analysis and cross tabulation',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/indicatorSection/programIndicator',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Computed values based on formula of data from events and tracker data used for analysis',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/indicatorSection/programIndicatorGroup',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Group of computed values based on formula of data from events and tracker data used of analysis',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/organisationUnitSection/organisationUnit',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Unit of data collection in reporting hierarchy, "WHERE" data is collected',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/organisationUnitSection/organisationUnitGroup',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Group of units of data collection in reporting hierarchy used for analysis and cross tabulation',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/organisationUnitSection/organisationUnitGroupSet',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'A set of groups of organisation units used for analysis and cross tabulation',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/organisationUnitSection/organisationUnitLevel',
    icon: 'icons/dhis-web-maintenance.png',
  ...
  },
  {
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Operations for moving organisation units within between parents within the hierarchy',
    onlyShowOnSearch: true,
  },
  {
    name: 'Program',
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'A set of data collection configurations for capturing events and tracker data',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/programSection/trackedEntityAttribute',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Properties/details of an entity/person/sample/case being tracked in tracker program',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/programSection/relationshipType',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Types or nature of relationship between entities/person/sample/cases being tracked in tracker program',
    onlyShowOnSearch: true,
  },
  {
    name: 'Tracked entity',
  ...
  },
  {
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Rules/Criterials for enforcing validations or expected behaviors in tracker program',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/programSection/programRuleVariable',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Variables/expressions in rules used to evaluate conditions and creatirias in validation',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/validationSection/validationRule',
    icon: 'icons/dhis-web-maintenance.png',
  ...
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance/#/list/validationSection/validationNotificationTemplate',
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Notification templates for messages on fullfilment of a validation rule',
    onlyShowOnSearch: true,
  },
  {
    name: 'Constant',
  ...
  },
  {
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Fields for extending additional properties for capturing information related to data captured in DHIS2',
    onlyShowOnSearch: true,
  },
  {
    name: 'Option set',
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'A set of choices to be offered as drop down selection menu for data entry and analysis',
    onlyShowOnSearch: true,
  },
  {
    name: 'Legend',
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'A predefined range of colors used and key of colors for data analysis',
    onlyShowOnSearch: true,
  },
  {
    name: 'Predicator',
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Rule for calculation of predicted value based on prediction formula',
    onlyShowOnSearch: true,
  },
  {
    name: 'Push analysis',
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Settings for pushing list of analysis dashboards to users mails and defined schedule',
    onlyShowOnSearch: true,
  },
  {
    ...
    icon: 'icons/dhis-web-maintenance.png',
    description:
      'Configuration of external rastor imagery layers for map overalys',
    onlyShowOnSearch: true,
  },
  {
    name: 'Group editor',
  ...
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance-dataadmin/displayResourceTableForm.action',
    icon: '/icons/dhis-web-maintenance-dataadmin.png',
    description:
      'Table for holding auto generated resources needed for reports and analytics tools',
    onlyShowOnSearch: true,
  },
  {
    ...
    defaultAction:
      '/dhis-web-maintenance-dataadmin/displayMaintenanceForm.action',
    icon: '/icons/dhis-web-maintenance-dataadmin.png',
    description:
      'Clearing of server cache, update changes made and for reloading apps',
    onlyShowOnSearch: true,
  },
  {
    ...
    icon: '/icons/dhis-web-maintenance-dataadmin.png',
    description:
      'Management of schedule for running analytics and resource tables creation',
    onlyShowOnSearch: true,
  },
  {
    ...
    icon: '/icons/dhis-web-maintenance-dataadmin.png',
    description:
      'Running analytics on demand and configuration of analytics before running',
    onlyShowOnSearch: true,
  },
  {
    ...
    description:
      'Customized single page reports for personalized/customized report outputs',
    onlyShowOnSearch: true,
  },
  {
    ...
    icon: '/icons/dhis-web-reporting.png',
    description:
      'Routine reports based on data entry forms layouts aggregated accross hierarchy and periods',
    onlyShowOnSearch: true,
  },
  {
    ...
    icon: '/icons/dhis-web-reporting.png',
    description:
      'Reports showing completeness and timelineness of submissions of datasets',
    onlyShowOnSearch: true,
  },
  {
    ...
    icon: '/icons/dhis-web-reporting.png',
    description:
      'Reports showing distribution of organisation units by groups and groupsets, e.g. ownership and types',
    onlyShowOnSearch: true,
  },
  {
    name: 'Resources',
    ...
    icon: '/icons/dhis-web-reporting.png',
    description:
      'Archive of files and other resources uploaded for reference purposes',
    onlyShowOnSearch: true,
  },
  {
    name: 'Data approval',
  ...
  },
  {
    ...
    icon: '/icons/dhis-web-maintenance-dataadmin.png',
    description:
      'Management, generation and use of SQL views for csv data analysis',
    onlyShowOnSearch: true,
  },
  {
    ...
    icon: '/icons/dhis-web-maintenance-dataadmin.png',
    description:
      'Statistics on creation of metadata and datavalues in the database',
    onlyShowOnSearch: true,
  },
];
